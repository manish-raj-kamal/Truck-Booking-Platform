                  ...
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {usr.role === 'superadmin' ? (
                      ...
                      <select
                        ...
                        className={`px-2 py-0.5 rounded-full text-xs font-semibold border-0 cursor-pointer flex-shrink-0 ${
              ...
              <div className="flex gap-2 mt-3 pt-3 border-t border-gray-100">
                <button
                  ...
                  className={`flex-1 bg-yellow-500 hover:bg-yellow-600 text-white py-2 rounded-lg font-semibold text-xs sm:text-sm transition ${
                    (usr.role === 'superadmin' && user.role !== 'superadmin') || (user.role === 'admin' && usr.role === 'admin' && usr._id !== user.id) ? 'opacity-50 cursor-not-allowed' : ''
                  }`}
                >
                  Edit
                </button>
                <button
                  ...
                  className={`flex-1 bg-red-500 hover:bg-red-600 text-white py-2 rounded-lg font-semibold text-xs sm:text-sm transition ${
                    usr._id === user.id || usr.role === 'superadmin' || (user.role === 'admin' && usr.role === 'admin') ? 'opacity-50 cursor-not-allowed' : ''
                  }`}
                >
                  Delete
                </button>
